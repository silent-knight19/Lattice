...
func TestSentinelIdentity(t *testing.T) {
	sentinels := []struct {
		...
		{"ErrInvalidCompactionPlan", errors.ErrInvalidCompactionPlan, "invalid compaction plan"},
		{"ErrByteCountOverflow", errors.ErrByteCountOverflow, "byte count overflow"},
		...
		{"ErrInvalidFileNum", errors.ErrInvalidFileNum, "invalid file number: must be greater than zero"},
		{"ErrInvalidFileSize", errors.ErrInvalidFileSize, "invalid file size: must be greater than zero"},
		{"ErrInvalidKeyRange", errors.ErrInvalidKeyRange, "invalid key range: smallest key sorts after largest key"},
		{"ErrInvalidSeqNumRange", errors.ErrInvalidSeqNumRange, "invalid sequence number range: smallest sequence number greater than largest sequence number"},
...
func TestSentinelWrappingWithErrorsIs(t *testing.T) {
	tests := []struct {
		...
		{"ErrInvalidCompactionPlan", errors.ErrInvalidCompactionPlan},
		{"ErrByteCountOverflow", errors.ErrByteCountOverflow},
...
func TestSentinelNegativeComparisons(t *testing.T) {
	allSentinels := []error{
		...
		errors.ErrInvalidCompactionPlan,
		errors.ErrByteCountOverflow,
