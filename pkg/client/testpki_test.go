...
func newClientTestCA(t *testing.T, name string) *clientTestCA {
	...
	template := &x509.Certificate{
		...
		Subject: pkix.Name{
			CommonName:   name,
			Organization: []string{"Lattice Client Test Authority"},
		},
...
func (ca *clientTestCA) issueCert(t *testing.T, name string, isClient, isServer bool, ou string) (certPath, keyPath string) {
	t.Helper()
